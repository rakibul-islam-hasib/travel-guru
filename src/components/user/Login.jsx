...
const Login = () => {
    const { user, handelGoogleLogin } = useContext(AuthProvider);
         ...
         :
            <div className='h-[88vh] flex flex-col justify-center items-center'>
                ...
                <div className="w-[30%]  mx-auto">
                    ...
                    {/* Google Login */}
                    <div onClick={googleLoginHandler} className="flex hover:cursor-pointer border mb-3 rounded-full px-5 py-2 justify-center items-center gap-4">
